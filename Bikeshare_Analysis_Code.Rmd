...
#Load Data
```{r, eval=FALSE}
#define function to read original files
#Since the original data are too big, I exported the csv file, which was used for data analysis.
#For analaysis, please skip the line till 133.
#The data that was uploaded to the moodle is the exported data described above.
...
#Clean Data
#Join bike share data from three cities
```{r}
